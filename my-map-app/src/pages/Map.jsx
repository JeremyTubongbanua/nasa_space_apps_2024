...
function Map() {
  return (
    <div className="flex flex-col gap-10 bg-cream bg-cover px-6 md:px-16 lg:px-48">
      <div>
        <h1 className="mt-10 md:mt-20 text-center text-4xl font-semibold md:text-6xl">Map</h1>
        <div className="mt-6 md:mt-10 flex flex-col justify-center gap-4 rounded-[20px] md:rounded-[60px] bg-lightblue p-8 md:p-12">
          ...
          <p className="text-sm md:text-base flex flex-col items-center">
          ...
          <div className="flex flex-col items-center justify-center gap-4">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-10">
              <img
                ...
                alt="SWOT"
                className="max-h-64 md:max-h-96 rounded-lg"
              />
              <img
      ...
      <div className="flex flex-col items-center justify-center gap-4">
        <div className="flex w-full flex-col items-center gap-2 overflow-hidden rounded-[20px] md:rounded-[60px] bg-gray-300 p-6 md:p-12 py-4">
          <strong className="text-xl md:text-3xl uppercase">Instructions</strong>
          <p className="text-sm md:text-base">
        ...
        <Link
          to={"/mapapp"}
          className="w-full md:w-2/4 rounded-lg bg-orange-300 p-5 text-center text-lg md:text-2xl font-semibold uppercase"
        >
          GO TO MAP
        </Link>
      </div>
